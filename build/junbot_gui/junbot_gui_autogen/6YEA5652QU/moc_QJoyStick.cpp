...
QT_MOC_LITERAL(1, 10, 13), // "keyNumChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 3) // "num"

    },
    "QJoyStick\0keyNumChanged\0\0num"
};
...
void QJoyStick::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QJoyStick *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QJoyStick::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QJoyStick::keyNumChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QJoyStick::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QJoyStick.data,
    qt_meta_data_QJoyStick,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void QJoyStick::keyNumChanged(int _t1)
{
